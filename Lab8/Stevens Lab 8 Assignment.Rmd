...
$\color{red}{\text{Good stuff overall, although I'm not sure why you state that the GLM should have the lowest predictive abilities. In addition, one detail you kind of missed is that the bioclim model doesn't use any absence or pseudo-absence data. +3.5}}$
...
$\color{red}{\text{Great critical thinking. +4}}$
...
$\color{red}{\text{Good. I can't answer all of your questions, but keep reading! +4}}$
