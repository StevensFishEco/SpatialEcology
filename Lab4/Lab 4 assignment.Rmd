...
PerformanceAnalytics::chart.Correlation(patchMetrics8 %>% select(-ID), histogram=F)
...
$\color{red}{\text{Cool exploration with the VIF. +4}}$
...
$\color{red}{\text{Total edge should definitely stay the same. And nice plots! +4}}$
...
$\color{red}{\text{Great work on this, Jeff. +4}}$